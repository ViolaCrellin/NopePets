...
namespace Server.Test.Integration
{
    public static class TestData
    {
        ...
        public static class Users
        {
            ...
            public static User MeJulie = new User("Me", "Julie", MeJulieUserId, "MeJulie@AliGsCrib.com",
                "RD8ihaProWRdvQ+MHtKK7A==", "MeJulie");

            public static User NewMeJulie = new User("Me", "Julie", "MeJulie@AliGsCrib.com", "RD8ihaProWRdvQ+MHtKK7A==",
                "MeJulie");

            public static UserCredentials MeJuliesLogin =
                new UserCredentials()
        ...
        public static class UsersPets
        {
            ...
            public static PetMetric VersaceConfidenceMetric =
                new PetMetric(VersacePetId, AnimalMetrics.ConfidenceMetricId, 0, DateTime.UtcNow);

            public static PetMetric VersaceHungerMetric =
                new PetMetric(VersacePetId, AnimalMetrics.HungerMetricId, 0, DateTime.UtcNow);
            ...
            public static PetMetric BurberryPetMetric =
                new PetMetric(BurberryPetId, AnimalMetrics.ConfidenceMetricId, 0, DateTime.UtcNow);

            public static PetMetric BurberryHungerMetric =
                new PetMetric(BurberryPetId, AnimalMetrics.HungerMetricId, 0, DateTime.UtcNow);
        ...
        public static class AnimalMetrics
        {
            ...
            public static Metric Hunger = new Metric(10, "Hunger",
                "Your pet has to eat regularly or else he will starve!",
                MetricType.IncreasesWithTime, 3);

            public static int ConfidenceMetricId = 20;

            public static Metric Confidence = new Metric(ConfidenceMetricId, "Confidence",
                "Sometimes your pet just wants reassurance that they are looking on point",
                MetricType.DecreasesWithTime, 4);
            ...
            public static AnimalMetric ChihuahuaIncreasingMetric = new AnimalMetric(Animals.Chihuahua.AnimalId,
                HungerMetricId, RequiredAttentiveness.Daily);

            public static AnimalMetric ChihuahuaDecreasingMetric = new AnimalMetric(Animals.Chihuahua.AnimalId,
                ConfidenceMetricId, RequiredAttentiveness.Constantly);
        ...
        public static class Interactions
        {
            ...
            public static MetricInteraction HungerFeedMeal =
                new MetricInteraction(AnimalMetrics.HungerMetricId, FeedMealInteractionId);

            public static MetricInteraction HungerFeedTreat =
                new MetricInteraction(AnimalMetrics.HungerMetricId, FeedTreatInteractionId);

            public static Interaction FeedMeal = new Interaction(FeedMealInteractionId, "Feed meal",
                "Don't let your pet starve! (But also don't let them get fat...)", 40, 6, CooldownTimeUnit.Hour);

            public static Interaction FeedTreat = new Interaction(FeedTreatInteractionId, "Feed treat",
                "Who's a good boy?", 2, 5, CooldownTimeUnit.Minute);
            ...
            public static MetricInteraction ConfidenceTakeSelfieWithPet =
                new MetricInteraction(AnimalMetrics.ConfidenceMetricId, TakeSelfieWithInteractionId);

            public static MetricInteraction ConfidenceBuyNewOutfit =
                new MetricInteraction(AnimalMetrics.ConfidenceMetricId, BuyNewOutfitForPetInteractionId);
